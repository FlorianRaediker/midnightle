      ...
      <div className="w-full columns-3 gap-0">
        ...
        <div className="mb-4 flex items-center">
          <input
            ...
            className="h-4 w-4 border-gray-300 bg-gray-100 text-primary focus:ring-2 focus:ring-primary-focus dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-neutral-900"
          />
          <label
