...
export const ImmigratePanel = () => {
  ...
  const handleSaveButton = () => {
    ...
    if (textarea && window.confirm(MIGRATE_CONFIRM)) {
  ...
  return (
    <div className="text-sm text-gray-500 dark:text-gray-300">
      ...
      <textarea
        ...
        id="immigration-code"
        rows={8}
        className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-primary dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
      ></textarea>
      <button
